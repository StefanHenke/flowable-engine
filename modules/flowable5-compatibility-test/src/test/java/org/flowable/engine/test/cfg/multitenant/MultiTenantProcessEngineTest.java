...
import org.flowable.compatibility.MultiSchemaFlowable5ProcessEngineFactory;
...
public class MultiTenantProcessEngineTest {
    ...
    private void setupTenantInfoHolder() {
        ...
        tenantInfoHolder.addTenant(null);
    ...
    private void setupProcessEngine(boolean sharedExecutor) {
        ...
        config.registerTenant(null, createDataSource("jdbc:h2:mem:activiti-null;DB_CLOSE_DELAY=1000", "sa", ""));
